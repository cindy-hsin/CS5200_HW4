package restaurant.dal;			// declare the package. A package is a grouping of interrelated classes.
...
public class ConnectionManager {
	...
	// User to connect to your database instance (Log in to SQL Workbench). By default, this is "root2".
	private final String user = "root";
	// Password for the user. (in Workbench)
	...
	public Connection getConnection() throws SQLException {
		...
		try {
			...
			connection = DriverManager.getConnection(
				// Building the URL that connects the Internet to our database
